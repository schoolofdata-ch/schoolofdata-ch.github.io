...
From the [master list](https://github.com/schoolofdata-ch/food-datasets/blob/master/data/food-datasets.csv) we will download and test datasets, do minor clean-up if necessary, check the [licenses](http://licenses.opendefinition.org/), document any issues we find. You may find our data wrangling [Toolbox](http://toolbox.schoolofdata.ch) and information on [Data Packages](http://openfood.schoolofdata.ch/about/) useful. By this time you may have other things to share or to ask, so let's [chat](#register)! If you publish a Data Package online, send us the URL for feedback and inclusion in [Datacentral](http://openfood.schoolofdata.ch). Then come to the Hackdays and make something amazing!
